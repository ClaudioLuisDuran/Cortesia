...
<title>.:: Sidra Cortesía :: Contacto ::.</title>
        ...
        <table border="0" cellpadding="7" cellspacing="7" style="border-collapse: collapse" bordercolor="#111111" width="97%" id="AutoNumber1" height="335">
          <tr>
            <td width="100%" height="335" valign="top">
                  ...
                  <span lang="es"><font size="4" color="#570E0A"><b>Contacto</b></font></span><img border="0" src="images/fotoproductos.png" align="left" hspace="15" vspace="15"></p>
                  <p style="margin-left: 10; margin-right: 10">&nbsp;</p>
                  <p style="margin-left: 10; margin-right: 10">
                  <span lang="es"><font face="Arial" size="2" color="#570E0A">
                  Use el siguiente formulario para ponerse en contacto con las 
                  secciones de administración, ventas o gerencia. Si desea 
                  transformarse en Distribuidor de nuestros productos, haga 
                  click aquí.</font></span></p>
...
function FrontPage_Form1_Validator(theForm)
{
  ...
  {
    alert("Please enter a value for the \"ciudad\" field.");
  ...
  {
    alert("Please enter a value for the \"provincia\" field.");
  ...
  {
    alert("Please enter a value for the \"asunto\" field.");
  ...
  {
    alert("Please enter a value for the \"comentarios\" field.");
    theForm.comentarios.focus();
    return (false);
  }
  return (true);
}
//--></script><!--webbot BOT="GeneratedScript" endspan --><form method="POST" action="graciascontacto.asp" onsubmit="return FrontPage_Form1_Validator(this)" language="JavaScript" name="FrontPage_Form1">
                    <div align="center">
                      <center>
                      <table border="0" cellpadding="3" cellspacing="3" style="border-collapse: collapse" bordercolor="#111111" width="518" id="AutoNumber2">
                        <tr>
                          <td width="178" align="right" valign="top">
                          <font color="#570E0A" size="2" face="Arial">
                          <span lang="es">Nombre completo: </span></font></td>
                          <td width="319"><font color="#570E0A" face="Arial">
                          <!--webbot b-value-required="TRUE" bot="Validation" --><input type="text" name="nombre" size="31"></font></td>
                        </tr>
                        <tr>
                          <td width="178" align="right" valign="top">
                          <font color="#570E0A" size="2" face="Arial">
                          <span lang="es">Ciudad: </span></font></td>
                          <td width="319"><font color="#570E0A" face="Arial">
                          <!--webbot b-value-required="TRUE" bot="Validation" --><input type="text" name="ciudad" size="31"></font></td>
                        </tr>
                        <tr>
                          <td width="178" align="right" valign="top">
                          <font color="#570E0A" size="2" face="Arial">
                          <span lang="es">Provincia: </span></font></td>
                          <td width="319"><font color="#570E0A" face="Arial">
                          <!--webbot b-value-required="TRUE" bot="Validation" --><input type="text" name="provincia" size="31"></font></td>
                        </tr>
                        <tr>
                          <td width="178" align="right" valign="top">
                          <font color="#570E0A" size="2" face="Arial">
                          <span lang="es">Email:</span></font></td>
                          <td width="319"><font color="#570E0A" face="Arial">
                          <!--webbot b-value-required="TRUE" bot="Validation" --><input type="text" name="email" size="31"></font></td>
                        </tr>
                        <tr>
                          <td width="178" align="right" valign="top">
                          <font color="#570E0A" size="2" face="Arial">
                          <span lang="es">Teléfono:</span></font></td>
                          <td width="319"><font color="#570E0A" face="Arial">
                          <!--webbot b-value-required="TRUE" bot="Validation" --><input type="text" name="telefono" size="31"></font></td>
                        </tr>
                        <tr>
                          <td width="178" align="right" valign="top">
                          <span lang="es">
                          <font face="Arial" size="2" color="#570E0A">Asunto</font></span><font color="#570E0A" size="2" face="Arial"><span lang="es">:</span></font></td>
                          <td width="319"><font color="#570E0A" face="Arial">
                          <!--webbot b-value-required="TRUE" bot="Validation" --><input type="text" name="asunto" size="31"></font></td>
                        </tr>
                        <tr>
                          <td width="178" align="right" valign="top">
                          <font color="#570E0A" size="2" face="Arial">
                          <span lang="es">Comentarios:</span></font></td>
                          <td width="319"><font color="#570E0A" face="Arial">
                          <!--webbot b-value-required="TRUE" bot="Validation" --><textarea rows="11" name="comentarios" cols="37"></textarea></font></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                          ...
                          <input type="submit" value="Enviar" name="B1"></font></td>
                        </tr>
                      </table>
                      </center>
                    </div>
      ...
      <a href="contacto.asp" style="text-decoration: none"><font color="#570E0A">
      La Bodega </font></a>&nbsp;&nbsp; :::&nbsp;&nbsp;&nbsp;
      ...
      <div align="center">
        ...
        <table border="0" cellspacing="6" style="border-collapse: collapse" width="749" cellpadding="6" height="87">
          <tr>
            ...
            <font face="Arial" size="2" color="#570E0A">Bodega: Ruta 40 Km 77. 
            Tunuyán. Mendoza. República Argentina</font></span></p>
            <p align="center"><span lang="es">
