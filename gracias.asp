...
Dim asuntook
asuntook = "[Desde Distribuidores en web Cortesia] "

cuerpo = " " & VbCrLf
cuerpo = cuerpo & "Nuevo contacto desde -Distribuidores- en la web de Sidra Cortesía." & VbCrLf & VbCrLf
        ...
        <table border="0" cellpadding="7" cellspacing="7" style="border-collapse: collapse" bordercolor="#111111" width="97%" id="AutoNumber1" height="177">
          <tr>
            <td width="100%" height="177" valign="top">
                  ...
                  <p style="margin-left: 10; margin-right: 10" align="center">
                  <font face="Arial" size="2" color="#570E0A"><span lang="es">
                  Muy pronto nos conectaremos con usted.</span></font></p>
                  <p style="margin-left: 10; margin-right: 10" align="center">
                  &nbsp;</p>
                  </td>
          </tr>
