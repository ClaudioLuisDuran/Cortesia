...
<title>.:: Sidra Cortesía :: La Bodega ::.</title>
        ...
        <table border="0" cellpadding="7" cellspacing="7" style="border-collapse: collapse" bordercolor="#111111" width="97%" id="AutoNumber1" height="335">
          <tr>
            <td width="100%" height="335" valign="top">
                  ...
                  <b><font color="#570E0A" size="4"><span lang="es">Conozca 
                  nuestra bodega</span></font></b></p>
                  <p style="margin-left: 10; margin-right: 10" align="center">
                  <img border="0" src="images/bodega1.jpg"></p>
                  <p style="margin-left: 10; margin-right: 10">
                  <font face="Arial" size="2" color="#570E0A"><span lang="es">Le 
                  mostramos nuestras instalaciones y tecnología. Le contamos 
                  como son nuestros procesos desde la cosecha hasta el embalaje 
                  final.</span></font></p>
                  <p style="margin-left: 10; margin-right: 10">&nbsp;</p>
                  <p style="margin-left: 10; margin-right: 10" align="center">
                  <img border="0" src="images/120px-Under_construction_icon-blue.svg.png"></p>
                  <p style="margin-left: 10; margin-right: 10" align="center">
                  <span lang="es"><font size="4" color="#570E0A"><b>[ Página en 
                  construcción ]</b></font></span></p>
                  </td>
          </tr>
        </table>
        </center>
