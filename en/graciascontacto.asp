...
<title>.:: Cortesia Cider :: Thanks! ::.</title>
...
Dim asuntook
asuntook = "[email generado en web Cortesia :: English] " & asunto

cuerpo = " " & VbCrLf
cuerpo = cuerpo & "Nuevo contacto desde la web de Sidra Cortesía. (Versión ENGLISH)" & VbCrLf & VbCrLf
        ...
        <table border="0" cellpadding="7" cellspacing="7" style="border-collapse: collapse" bordercolor="#111111" width="97%" id="AutoNumber1" height="177">
          <tr>
            <td width="100%" height="177" valign="top">
                  ...
                  <span lang="es"><font size="4" color="#570E0A"><b>Contact</b></font></span></p>
                  <p style="margin-left: 10; margin-right: 10">
                  <b>
                  <img border="0" src="../images/fotomanzanas.png" align="left" hspace="15" vspace="15"></b></p>
                  <p style="margin-left: 10; margin-right: 10" align="center">
                  <b><font color="#570E0A" size="2" face="Arial">Thank you for 
                  your interest! </font></b></p>
                  <p style="margin-left: 10; margin-right: 10" align="center">
                  <font color="#570E0A" size="2" face="Arial">The email has been 
                  sent successfully. </font></p>
                  <p style="margin-left: 10; margin-right: 10" align="center">
                  <font color="#570E0A" size="2" face="Arial">Soon we will 
                  contact you.</font></p>
                  </td>
          </tr>
        </table>
