...
Dim asuntook
asuntook = "[Desde Distributors en web Cortesia (ENGLISH)] "

cuerpo = " " & VbCrLf
cuerpo = cuerpo & "Nuevo contacto desde -Distributors- en la web de Sidra Cortesía (ENGLISH)." & VbCrLf & VbCrLf
        ...
        <table border="0" cellpadding="7" cellspacing="7" style="border-collapse: collapse" bordercolor="#111111" width="97%" id="AutoNumber1" height="177">
          <tr>
            <td width="100%" height="177" valign="top">
                  ...
                  <p style="margin-left: 10; margin-right: 10" align="center">
                  <b><font color="#570E0A" size="2" face="Arial">Very soon we 
                  will connect with you.<span lang="es">.</span></font></b></p>
                  </td>
          </tr>
        </table>
        </center>
